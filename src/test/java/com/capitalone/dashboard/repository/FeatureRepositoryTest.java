...
public class FeatureRepositoryTest extends MongoServerBaseRepositoryTest {
	...
	private static String maxDateLoser = "";
	private static String currentSprintEndDate = "";
...
//	private static final ObjectId v1CollectorId = new ObjectId();
	...
	public void testGetFeatureIdById_HappyPath() {
		...
		assertEquals("Expected feature ID did not match actual feature ID", testStoryId,
				featureRepo.getFeatureIdById(testStoryId).get(0).getsId());
	}
		...
		assertEquals(
				...
				featureRepo
						.findTopByCollectorIdAndChangeDateGreaterThanOrderByChangeDateDesc(
								jiraCollectorId, maxDateLoser).get(0).getChangeDate());
	}
