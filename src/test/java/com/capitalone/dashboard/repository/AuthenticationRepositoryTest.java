...
public class AuthenticationRepositoryTest extends MongoServerBaseRepositoryTest {
	...
	@Test
	public void verifyExistingWithNewPasswords() {
	...
	@Test
	public void verifyWithBadPasswords()  {
		String username = "username" + System.currentTimeMillis();
