...
import com.capitalone.dashboard.repository.MongoServerBaseRepositoryTest;
...
public class DashboardUtilsTest extends MongoServerBaseRepositoryTest {
    ...
    @Test
    public void getUniqueCollectorItemIDsFromAllComponents()  {
